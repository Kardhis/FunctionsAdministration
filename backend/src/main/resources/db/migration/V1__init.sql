-- Flyway migration V1
-- Create tables for: users + habits module (multi-user)
-- Target: MySQL 8+
...
CREATE TABLE IF NOT EXISTS habits (
  ...
  target_type ENUM('minutes_per_day','sessions_per_week','hours_per_month') NOT NULL,
  target_value DECIMAL(10,2) NOT NULL,
  target_period ENUM('day','week','month') NOT NULL,
