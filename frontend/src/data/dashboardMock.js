...
export const dashboardNav = [
  ...
  },
  {
    ...
    icon: 'tasks',
    children: [
      { key: 'tasks-list', label: 'Totes les tasques', to: '/dashboard/tasks/list' },
      { key: 'tasks-today', label: 'Avui', to: '/dashboard/tasks/today' },
      { key: 'tasks-eisenhower', label: 'Eisenhower', to: '/dashboard/tasks/eisenhower' },
      { key: 'tasks-calendar', label: 'Calendari', to: '/dashboard/tasks/calendar' },
      { key: 'tasks-backlog', label: 'Backlog', to: '/dashboard/tasks/backlog' },
      { key: 'tasks-manage', label: 'Gestió', to: '/dashboard/tasks/manage' },
    ],
  },
